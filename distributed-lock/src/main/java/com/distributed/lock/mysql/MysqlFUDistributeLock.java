    ...
    public void lock() {
        ...
        try {
            for (; ; ) {
                ...
                com.msb.lock.mysql.lock.Utils.gracefulClose(resultSet, statement, connection);
                ...
                try {
                    ...
                    com.msb.lock.mysql.lock.Utils.gracefulClose(insertStatement, insertConnection);
                }
            }
        } catch (Exception e) {
            log.error("获取锁异常", e);
        } finally {
            com.msb.lock.mysql.lock.Utils.gracefulClose(resultSet, statement);
        }
    }
